<template>
    <div class="container">
        <div>
            ...
            <b-row>
                ...
                <b-col cols="6" class="px-0">
                        ...
                        <span class="text-danger"
                            v-if="false">(only Chingchong Holder 1:1)</span
                        >                        
                </b-col>
            </b-row>
            <!-- Platform option -->
            ...
            <b-row class="mt-1">
                <b-col cols="4" style="align-items: 1; text-align: end">
                    <p v-if="false">Discord link</p></b-col
                >
                <b-col cols="6" class="px-0">
                    <b-form-group
                        id="input-group-3"
            ...
            <b-row class="mt-1">
                <b-col cols="4" style="align-items: 1; text-align: end">
                    <p v-if="false">Twitter link</p></b-col
                >
                <b-col cols="6" class="px-0">
                    <b-form-group
                        id="input-group-3"
            ...
            <b-row class="mt-1" v-if="false">
                <b-col cols="4" style="align-items: 1; text-align: end">
                    <p v-if="false">Facebook link</p></b-col
                >
                <b-col cols="6" class="px-0">
                    <b-form-group
                        id="input-group-3"
